          ...
          <AreaChart data={data} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
            <defs>
              <linearGradient id="colorRisk" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#d47b70" stopOpacity={0.4}/>
                <stop offset="95%" stopColor="#5e9b83" stopOpacity={0}/>
              </linearGradient>
            </defs>
            <XAxis 
              dataKey="name" 
              tick={{ fontSize: 10, fill: "#708188", fontWeight: 600 }} 
              axisLine={false} 
              tickLine={false} 
              minTickGap={10} 
            />
            <Tooltip
              contentStyle={{ backgroundColor: "#1d3137", borderRadius: "8px", border: "none", color: "#ffffff", boxShadow: "0 10px 25px rgba(0,0,0,0.2)", fontSize: "12px", fontWeight: 600 }}
              itemStyle={{ color: "#ffffff", fontWeight: 800 }}
              cursor={{ stroke: "rgba(212, 123, 112, 0.4)", strokeWidth: 2, strokeDasharray: "5 5" }}
            />
            <Area 
              type="monotone" 
              dataKey="risk" 
              ...
              fillOpacity={1} 
              fill="url(#colorRisk)" 
              activeDot={{ r: 6, fill: "#ffffff", stroke: "#d47b70", strokeWidth: 2 }} 
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
